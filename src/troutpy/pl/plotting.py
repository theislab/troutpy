...
def nmf_gene_contributions(
    ...
    ...     sdata, nmf_adata_key="nmf_data", save=True, saving_path="./results", cmap="plasma", figsize=(10, 8)
    ... )
    """
    adata = sdata[nmf_adata_key]
...
def apply_exrnaH_to_cellular_to_create_cellularW(adata_extracellular_with_nmf, adata_annotated_cellular):
    ...
    Example:
    --------
    >>> adata_cellular = apply_exrnaH_to_cellular_to_create_cellularW(
    ...     adata_extracellular_with_nmf, adata_annotated_cellular
    ... )
